...
Raggit is a playful, interactive frontend experience that brings Retrieval-Augmented Generation (RAG) to life.

Instead of treating AI as something hidden behind APIs and terminals, Raggit turns it into something you can **see, feel, and interact with in real time**.

It was built on one of those slow Sundays where I thought:

> “What if understanding AI didn’t feel like reading documentation… but like using a product?”
...
This UI was built with one goal:

> Make RAG feel like a product, not a system.
...
- Custom styling with a focus on motion + clarity
...
- WebSocket-level interactivity is not implemented yet 😅  Help meeee......
...
Most RAG apps feel like dashboards or a bunch of nodes lined up together.

This one tries to feel like an experience.

Still tweaking. Still polishing. Still obsessing over tiny UI details no one asked for.
